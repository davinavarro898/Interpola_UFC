...
class ChangeCompressedPressureEnglish:
    ...
    def interpolDataFrame(self):
        data_frame1 = pd.read_excel(f'{self.fluid}_INGLES.xlsx', sheet_name=f'{self.fluid}_COMP_{self.pressure1}'
                                                                            f'psi_INGLES')
        ...
        data_frame2 = pd.read_excel(f'{self.fluid}_INGLES.xlsx', sheet_name=f'{self.fluid}_COMP_{self.pressure2}'
                                                                            f'psi_INGLES')

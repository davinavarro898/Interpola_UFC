...
class ChangeCompressedPressureSI:
    ...
    def interpolDataFrame(self):
        data_frame1 = pd.read_excel(f'{self.fluid}_SI.xlsx', sheet_name=f'{self.fluid}_COMP_{self.pressure1}bar_SI')
        ...
        data_frame2 = pd.read_excel(f'{self.fluid}_SI.xlsx', sheet_name=f'{self.fluid}_COMP_{self.pressure2}bar_SI')
